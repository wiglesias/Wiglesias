 ...
 */
class Version20170517153417 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE customer CHANGE email email VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
