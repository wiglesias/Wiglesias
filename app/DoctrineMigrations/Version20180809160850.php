 ...
 */
class Version20180809160850 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE contact_message DROP removed_at, CHANGE description description TEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE portafolio DROP removed_at, CHANGE description description TEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE post DROP removed_at, CHANGE description description TEXT DEFAULT NULL');
